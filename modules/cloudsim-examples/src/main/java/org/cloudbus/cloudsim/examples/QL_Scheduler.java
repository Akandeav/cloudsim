...
public class QL_Scheduler {
    ...
    public static void main(String[] args) {
        Log.printLine("Starting QL Scheduler...");
        ...
        try {
            ...
            QLDatacenterBroker broker = createBroker("Broker_0");
            ...
            Log.printLine(QL_Scheduler.class.getName() + " finished!");
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private static QLDatacenterBroker createBroker(String name) throws Exception {
        return new QLDatacenterBroker(name);
    }
    ...
    private static void printCloudletList(List<Cloudlet> list) {
        ...
        Log.printLine("Makespan using QL: " + makespan);
        //Added:
